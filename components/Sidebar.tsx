      ...
      <div className="p-6 border-b border-gray-800 flex-shrink-0">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-transparent border border-gray-700 rounded-lg px-4 py-2 pl-10 text-white placeholder-gray-500 focus:outline-none focus:border-gray-500 transition-colors"
          />
          <svg
          ...
          {buildings.map((building) => {
            ...
            return (
              ...
              >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 backdrop-blur-md bg-black/40 px-3 py-2 flex items-center justify-between">
                    <div className="flex items-center gap-2 min-w-0">
                      <h3 className="text-sm font-semibold text-white truncate">{building.name}</h3>
                      ...
                      {building.category && (
                        <span className="text-xs text-gray-300 flex-shrink-0">{building.category}</span>
                      )}
                    </div>
